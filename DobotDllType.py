...
def load():
    if platform.system() == "Windows":
        print("La dll que está utilizando es de 64 bits，para un funcionamiento sin problemas，asegúrese de que su entorno python también es de 64 bits")
        print("El entorno Python es：",platform.architecture())
